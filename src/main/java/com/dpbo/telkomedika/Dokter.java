...
public abstract class Dokter extends User {
  ...
  public static void buatLaporan(ArrayList<Pendaftaran> pendaftaran) {
    ...
    do {
      ...
      System.out.println("Buat laporan untuk pendaftaran ke-: ");
      ...
      if (laporanKe < 0 || laporanKe > pendaftaran.size()) {
        System.out.println("@ Harap pilih antara 0 - " + pendaftaran.size());
      }
  ...
  public static void showDokterPage() {
    ...
    do {
      ...
      if (menu == 1) {
        ...
        System.out.println("@ Harap pilih antara menu 0 atau 1");
      }
    } while (menu != 0);
  }
